...
def request_site(arq, site): # Seleciona o diretório e Grava conforme o HTML
    ...
    nome_arquivo = arq # "001/files/arq01.txt"
    print(f"[DEBUG] URL recebida: {site}")
    # Faz a requisição para o site
    # em formato de HTML --> TXT
    url = site # 'https://g1.globo.com/politica/noticia/2025/03/19/stf-tem-maioria-para-manter-dino-zanin-e-moraes-em-julgamento-de-denuncia-de-golpe-contra-bolsonaro-e-aliados.ghtml'
...
def ia_process(arq, arq_process, chat): # Processa o arquivo e gera a resposta do modelo
    arquivo = arq #"001/files/arq01.txt"
    ...
    arquivo_process = arq_process #"001/files/files_process/arq_process01.txt"
