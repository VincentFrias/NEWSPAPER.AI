...
def main():
    ...
    for i in range(len(arquivos)):
        ...
        chat = "Reescreva o texto de forma mais detalhada e aprofundada, tornando uma noticia de jornal, ampliando as ideias para atingir uma extensão entre 25.000 e 40.000 caracteres. Reserve a primeira linha a um título curto e cativante relacionado aos textos de apoio, sem utilizar subtítulos ao longo do texto. Mantenha a redação objetiva, informativa, clara e livre de ambiguidades, garantindo total neutralidade política. Preserve a fidelidade ao conteúdo original, sem incluir dados fictícios, opiniões pessoais ou informações não verificadas. Não explique seu processo de escrita em nenhum momento. Evite o uso de caracteres especiais, como asteriscos, travessões decorativos ou emojis. Evite fazer muitos pequenos paragrafos. Ao final de cada parágrafo, adicione a marcação /n para indicar a quebra de parágrafo."
